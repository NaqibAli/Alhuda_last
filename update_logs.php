        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style2 text-white">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page">Update Logs</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header pb-0">
                    <div class="row">
                        <div class="col-md-6">
                            <h4 class="card-title mg-b-2 mt-2 page">Members Update Logs Report</h4>
                        </div>
                ...
                <div class="card-body">
                    <div class="mg-t-5 mb-4">
                        ...
                        <form id="form" method="post" class="form-horizontal" data-parsley-validate="">
                            ...
                            <div class="form-group overflow-hidden">
                                ...
                                <input class="form-control" member_id="" autocomplete="off" list="members"
                                    id="member_id" name="member_id" placeholder="Choose Member">
                                <datalist id="members">
                    ...
                    <div class="table-responsive">
                        <table class="table text-md-nowrap table-bordered bd bd-0" id="table">
                            <thead class="">
                                <tr>
                                    <th class="wd-15p">#</th>
                                </tr>
...
?>
    ...
    <script type="text/javascript" src="models/updatelog.js"></script>