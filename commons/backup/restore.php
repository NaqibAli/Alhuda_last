...
define("BACKUP_FILE", 'backup-backuptest - Mar 11, 2021 - 120616.sql'); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
...
$result = $restoreDatabase->restoreDb(BACKUP_FILE) ? 'OK' : 'KO';
